...
export default function CompetitionsPage() {
  ...
  async function qualifyGroups(competitionId: string, name: string) {
    const advanceRaw = prompt(`Teams to advance per group for ${name} (1 = group winners, 2 = top two):`, "1");
  ...
  return (
    ...
    >
      ...
      <Card title="Assign agents to competition">
      ...
      <Card title="Linked teams">
        <div className="space-y-2">
          {entries.map((e) => (
            ...
            >
              <span className="min-w-0">
                <strong>{e.teamName}</strong> in {e.competitionName}
              </span>
